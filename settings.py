...
def getDB():
	#print(splitpath(PROJECT_ROOT)[-2])
	if splitpath(PROJECT_ROOT)[-2] == 'thewulf.org':
		return 'thewulfdb'
	elif LIVE_DEV:
		return 'thewulfdb'
	else:
...
def getMediaRoot():
	if splitpath(PROJECT_ROOT)[-2] == 'thewulf.org':
		return '/home/mwinter80/thewulf.org/public/media/'
	elif LIVE_DEV:
		return '/home/mwinter80/thewulf.org/public/media/'
	else:
		return '/home/mwinter80/dev.thewulf.org/public/media/'
	
def getMediaURL():
	if splitpath(PROJECT_ROOT)[-2] == 'thewulf.org':
		return 'http://thewulf.org/media/'
	elif LIVE_DEV:
		return 'http://thewulf.org/media/'
	else:
		return 'http://dev.thewulf.org/media/'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': getDB(),                      # Or path to database file if using sqlite3.
